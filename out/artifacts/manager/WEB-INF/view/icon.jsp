						...
						<div class="tab-content">
							<div class="tab-pane active fontawesome-demo" id="tab_1_1">
								...
								<div class="row margin-bottom-20">
									...
									<div class="fa-item col-md-3 col-sm-4">
										<i class="fa fa-soundfront"></i> fa-soundfront
									</div>
									<div class="fa-item col-md-3 col-sm-4">
								...
								<div class="row margin-bottom-20">
									...
									<div class="fa-item col-md-3 col-sm-4">
										<i class="fa fa-front"></i> fa-front
									</div>
									<div class="fa-item col-md-3 col-sm-4">
										<i class="fa fa-front-download"></i> fa-front-download
									</div>
									<div class="fa-item col-md-3 col-sm-4">
										<i class="fa fa-front-upload"></i> fa-front-upload
									</div>
									<div class="fa-item col-md-3 col-sm-4">
									...
									<div class="fa-item col-md-3 col-sm-4">
										<i class="fa fa fa-th-list"></i> fa-reorder <span class="text-muted">(alias)</span>
									</div>
									<div class="fa-item col-md-3 col-sm-4">
							...
							<div class="tab-pane glyphicons-demo" id="tab_1_2">
								...
								<ul class="bs-glyphicons bs-glyphicons-list">
									...
									<li>
										<span class="glyphicon glyphfa fa-plus">
										</span>
										<span class="bs-glyphicon-class">
										glyphicon glyphfa fa-plus </span>
									</li>
									<li>
									...
									<li>
										<span class="glyphicon glyphicon-front">
										</span>
										<span class="bs-glyphicon-class">
										glyphicon glyphicon-front </span>
									</li>
									<li>
									...
									<li>
										<span class="glyphicon glyphfa fa-search">
										</span>
										<span class="bs-glyphicon-class">
										glyphicon glyphfa fa-search </span>
									</li>
									<li>
									...
									<li>
										<span class="glyphicon glyphfa fa-trash">
										</span>
										<span class="bs-glyphicon-class">
										glyphicon glyphfa fa-trash </span>
									</li>
									<li>
									...
									<li>
										<span class="glyphicon glyphfa fa-plus-sign">
										</span>
										<span class="bs-glyphicon-class">
										glyphicon glyphfa fa-plus-sign </span>
									</li>
									<li>
									...
									<li>
										<span class="glyphicon glyphicon-front-download">
										</span>
										<span class="bs-glyphicon-class">
										glyphicon glyphicon-front-download </span>
									</li>
									<li>
										<span class="glyphicon glyphicon-front-upload">
										</span>
										<span class="bs-glyphicon-class">
										glyphicon glyphicon-front-upload </span>
									</li>
									<li>
							...
							<div class="tab-pane" id="tab_1_3">
								...
								<div class="simplelineicons-demo">
									...
									<span class="item-box">
									<span class="item">
									<span  class="icon-camcorder"></span>
									&nbsp;icon-camcorder </span>
									</span>
									<span class="item-box">
									<span class="item">
									...
									<span class="item-box">
									<span class="item">
									<span  class="icon-front-download"></span>
									&nbsp;icon-front-download </span>
									</span>
									<span class="item-box">
									<span class="item">
									<span  class="icon-front-upload"></span>
									&nbsp;icon-front-upload </span>
									</span>
									<span class="item-box">
									<span class="item">
