		...
		<div class="widget box">
			...
			<div class="widget-content  no-padding">
				<div class="dataTables_header clearfix">
					...
					<form class="searchForm" action="upMerchMs/search" method="post"
						...
						<table class="searchTable">
							...
							<tr>
								...
								<td nowrap="nowrap" class="col-md-1">审核状态</td>
								<td nowrap="nowrap" class="col-md-3">
									<select name="Check" class="form-control">
										<option value="" >请选择</option>
										<option value="1" ${Check eq '1' ? 'selected' : '' }>已审核</option>
										<option value="0" ${Check eq '0' ? 'selected' : '' }>未审核</option>
									</select></td>
				...
				<div class="button-group">
					...
					<!-- 批量同步 -->
					<a href="upMerchMs/syncToChannelMerch" id="merch_del" 
				...
				<table
					...
					<tbody>
						<c:forEach items="${UpMerchInfoMsList }" var="item"
							varStatus="status">
							<tr>
...
<script>
	...
	function fileup(obj) {
		...
		$.ajax({
			...
			success : function(returndata) {
				alert(returndata.message);loadHtml("upMerchMs/search");
			},
	...
	function synchronization(){
	 	AjaxRequest("upMerchMs/syncToChannelMerch", {}, function success(resp){
